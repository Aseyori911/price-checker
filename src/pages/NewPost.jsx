...
function NewPost() {
  ...
  const handleSubmit = () => {
    if (!form.product || !form.price || !form.category || !form.state || !form.market) {
  ...
  if (submitted) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: theme.bg, fontFamily: "'DM Sans', 'Segoe UI', sans-serif", padding: '24px' }}>
        <div style={{ background: theme.card, border: `1px solid ${theme.cardBorder}`, borderRadius: '24px', padding: '60px 40px', textAlign: 'center', maxWidth: '400px', width: '100%' }}>
          ...
          <div style={{ marginTop: '24px', padding: '12px', borderRadius: '10px', background: `${theme.accent}15`, border: `1px solid ${theme.accent}30` }}>
            <p style={{ color: theme.accent, fontSize: '12px', fontWeight: 600 }}>Redirecting to feed...</p>
          </div>
        </div>
      </div>
    );
      ...
      <main style={{ flex: 1, overflowX: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: '40px', alignItems: 'flex-start', flexWrap: 'wrap' }}>
            ...
            {preview ? (
              ...
              <>
                <div style={{ width: '100%', height: '180px', borderRadius: '18px', border: `2px dashed ${theme.accent}50`, background: `${theme.accent}08`, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
                  ...
                  <p style={{ fontSize: '13px', fontWeight: 600, color: theme.accent, margin: 0 }}>Add a product photo</p>
          ...
          <div style={{ flex: 1, minWidth: '280px', display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            {/* Location */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <label style={labelStyle}>Auto-Detect Location</label>
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <HapticButton
                  ...
                  disabled={locating}
                  style={{ padding: '12px 16px', borderRadius: '10px', fontSize: '13px', fontWeight: 700, background: locating ? theme.pill : `linear-gradient(135deg, ${theme.accent}, #00c853)`, color: locating ? theme.textMuted : '#0a0a0f', border: 'none', whiteSpace: 'nowrap' }}
                >
